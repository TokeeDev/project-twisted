  ...
  return (
    <div className="min-h-screen bg-black text-white p-4 md:p-8">
      <div className="container mx-auto max-w-3xl">
        <Link href="/admin" className="inline-flex items-center text-twisted-neon hover:text-twisted-neon/80 mb-6 text-sm">
          <ArrowLeft size={16} className="mr-1" />
          Back to Admin Dashboard
        </Link>
        <h1 className="text-3xl font-bold mb-8 text-center text-twisted-neon">Manage Menu Items</h1>
