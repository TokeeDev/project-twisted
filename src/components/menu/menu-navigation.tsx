...
export function MenuNavigation({ sections }: MenuNavigationProps) {
  ...
  return (
    <div className="bg-twisted-darker rounded-lg shadow-[0_0_15px_rgba(153,51,255,0.2)] p-4">
      <h2 className="text-xl font-semibold mb-4 text-twisted-neon">Menu</h2>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                activeSection === id && "bg-twisted-violet/30 text-twisted-neon font-medium"
              )}
