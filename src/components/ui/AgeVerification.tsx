  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl font-bold mb-6 cyber-text" data-oid="jul4or1">
          Age Verification
        </h2>

        <div className="age-badge-lg mx-auto mb-6" data-oid="aq8wvsd">
          21+
        </div>

        <p className="mb-8" data-oid="47t:-z9">
        ...
        <div
          ...
          data-oid="xu--yks"
        >
          <Button variant="primary" onClick={handleVerify} data-oid="plkuxvq">
            I am 21 or older
          </Button>
        ...
        {error && (
          <div className="mt-6 text-red-400" data-oid="f-cf7:b">
