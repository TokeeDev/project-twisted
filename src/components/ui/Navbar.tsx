  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between rounded-md px-6 py-2 transition-colors duration-300 bg-black/90 backdrop-blur-md"> {/* Applied permanent background */} 
          <a href="/" className="text-2xl md:text-3xl font-bold text-white">
            <Image src="/twisted-logo.png" alt="Logo" width={100} height={100} />
          </a>
      ...
      <div
        ...
        <div className="flex flex-col space-y-4 px-4">
          {[{ label: 'Menu', href: '/menu' }, { label: 'Events', href: '/events' }, { label: 'About', href: '/about' }, { label: 'Contact', href: '/contact' }].map((item) => (
            <a 
              key={item.label} 
              href={item.href}
