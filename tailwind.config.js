    ...
    extend: {
      ...
      keyframes: {
        ...
        "vhs-text": {
          "0%, 100%": {
            textShadow:
              "1px 1px 0px rgba(0, 255, 255, 0.5), -1px -1px 0px rgba(255, 0, 255, 0.5)",
          },
          "50%": {
            textShadow:
              "-1px 1px 0px rgba(0, 255, 255, 0.5), 1px -1px 0px rgba(255, 0, 255, 0.5)",
      ...
      boxShadow: {
        ...
        "neon-glow":
          "0 0 5px theme(colors.neon-green), 0 0 15px theme(colors.neon-green), 0 0 25px theme(colors.neon-green)",
      },
      borderRadius: {
        lg: "var(--radius)",
